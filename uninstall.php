...
if ( defined( 'WP_UNINSTALL_PLUGIN' ) ) {
	...
	error_log( 'Started uninstalling LeefCoin and Altcoin Wallets' );
	...
	// remove LeefCoin builtin adapter settings
	$option_slug = 'wallets-LeefCoin-core-node-settings';
	...
	error_log( 'Finished uninstalling LeefCoin and Altcoin Wallets' );
}
