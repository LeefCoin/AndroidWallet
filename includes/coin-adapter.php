 ...
 * If your coin is a LeefCoin fork that utilizes a standard RPC API you can subclass
	...
	abstract class Dashed_Slug_Wallets_Coin_Adapter {
		...
		public function action_wallets_admin_menu() {
			...
			add_submenu_page(
				...
				sprintf( 'LeefCoin and Altcoin Wallets: %s (%s) Adapter Settings', $this->get_adapter_name(), $this->get_symbol() ),
		...
		/**
		 * LeefCoin settings page callback. Renders the settings page.
		 *
		 * @internal
		 *
		 */
		 ...
		 * among all loaded adapters. Returns 'LFC' for LeefCoin.
		 *
		 * @api
		 ...
		 * Coin name.
		 *
		 * The full name of the coin that this adapter gives access to. e.g. 'LeefCoin'
		 *
		 * @api
		 * @return string
		 */
		 ...
		 *
		 * e.g. for LeefCoin, this would be "LeefCoin". Override this as needed.
		 *
		 * @deprecated Use address_to_qrcode_uri.
		 * @since 2.8.1 Superseeded by address_to_qrcode_uri
		 * @see https://github.com/LeefCoin/bips/blob/master/bip-0020.mediawiki
		 ...
		 *
		 * Wallets such as the LeefCoin wallet have a -blocknotify feature that lets you specify a command line
