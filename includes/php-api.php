...
if ( ! class_exists( 'Dashed_Slug_Wallets_PHP_API' ) ) {
	...
	class Dashed_Slug_Wallets_PHP_API {
		 ...
		 *
		 * Example: LeefCoin balance of current user:
		 *
		 *      $LFC_balance = apply_filters( 'wallets_api_balance', 0, array( 'symbol' => 'LFC' ) );
		 *
		 ...
		 *
		 * Example: Available LeefCoin balance of current user:
		 *
		 *      $LFC_balance = apply_filters( 'wallets_api_available_balance', 0, array( 'symbol' => 'LFC' ) );
		 *
		 * Example: Available Litecoin balance of user 2:
		 *
		 *      $LFC_balance = apply_filters( 'wallets_api_available_balance', 0, array(
		 *          'symbol' => 'LTC',
		 *          'user_id' => 2,
		 *      ) );
		 *
		 ...
		 *
		 * Example: Ten most recent LeefCoin transactions of current user:
		 *
		 *     $LFC_txs = apply_filters( 'wallets_api_transactions', array(), array( 'symbol' => 'LFC' ) );
		 *
		 ...
		 *
		 * Example: LeefCoin deposit address of  the current user:
		 *
		 *      $deposit_address = apply_filters( 'wallets_api_deposit_address', '', array( 'symbol' => 'LFC' ) );`
		 *
		 ...
		 *
		 * Example: Cancel a trade transaction with TXID `T-LFC-DOGE-O5be995f006796-O5be99619d1f2d-2`. This will also cancel transactions ending with `-1`, `-3` and `-4` (total of 4 transactions).
		 *
		 * @api
		 ...
		 *
		 * Example: Retry a trade transaction with TXID `T-LFC-DOGE-O5be995f006796-O5be99619d1f2d-2`. This will also retry transactions ending with `-1`, `-3` and `-4` (total of 4 transactions).
		 *
		 * @api
		 * @since 3.9.0 Introduced
		 * @param array $args Array of arguments to this filter:
