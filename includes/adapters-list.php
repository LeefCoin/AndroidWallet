...
if ( ! class_exists( 'Dashed_Slug_Wallets_Adapter_List' ) ) {
	class Dashed_Slug_Wallets_Adapter_List {
		...
		public function action_admin_menu() {
			if ( current_user_can( 'manage_wallets' ) ) {
				add_submenu_page(
					...
					'LeefCoin and Altcoin Wallets Adapters list',
					'Adapters',
					'manage_wallets',
		...
		public function wallets_adapters_page_cb() {
			...
			?><h1><?php esc_html_e( 'LeefCoin and Altcoin Wallets coin adapters list', 'wallets' ); ?></h1>
				<p><?php esc_html_e( 'This plugin uses Coin Adapters to communicate with actual coin wallets.', 'wallets' ); ?></p>
				<p><?php esc_html_e( 'A LeefCoin core adapter is built-in, and you can download more coin adapters for free from the dashed-slug website.', 'wallets' ); ?></p>
