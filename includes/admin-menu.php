...
if ( ! class_exists( 'Dashed_Slug_Wallets_Admin_Menu' ) ) {
	class Dashed_Slug_Wallets_Admin_Menu {
		...
		public function wallets_page_cb() {
			...
			<h1><?php echo 'LeefCoin and Altcoin Wallets'; ?></h1>
			...
			?>
			<a href="https://en.LeefCoin.it/wiki/Enabling_SSL_on_original_client_daemon">
			<?php
			...
			<?php
				esc_html_e(
					'By continuing to use the LeefCoin and Altcoin Wallets plugin, ' .
			...
			<div class="card">
				...
				<ol>
					...
					<?php
						echo __(
							'Download the <strong>LeefCoin and Altcoin Wallets bundle</strong>. ' .
			...
			<div class="card">
				...
				<ol>
					...
					<?php
						echo __(
							'Donate a few shatoshi to the dashed-slug LeefCoin address: ' .
							'<a href="LeefCoin:1DaShEDyeAwEc4snWq14hz5EBQXeHrVBxy?label=dashed-slug&message=donation">1DaShEDyeAwEc4snWq14hz5EBQXeHrVBxy</a>.', 'wallets'
						);
					?>
						...
						<div
							...
							<div
								...
								<p
									align="center">Please Donate To LeefCoin Address: <b>[[address]]</b></p>
							...
							<div
								...
								Donation of <b>[[value]] LFC</b> Received. Thank You.
							</div>
			...
			<div class="card">
				...
				<p><?php esc_html_e( '"App extensions" are plugins that work on top of the LeefCoin and Altcoin Wallets plugin to provide new functionality to users.', 'wallets' ); ?></p>
			...
			<div class="card">
				...
				<p><?php esc_html_e( 'With "coin adapters" you can make the LeefCoin and Altcoin Wallets plugin work with other stand-alone and/or web wallets to add support for additional cryptocurrencies. ', 'wallets' ); ?></p>
...
?>
		...
		public function footer() {
			...
			<div class="card wallets-footer-message">
				<p>
				<?php
					echo __( 'Found <strong>LeefCoin and Altcoin Wallets</strong> useful? Want to help the project? ', 'wallets' );
				?>
				</p>
				<p>
				<?php
