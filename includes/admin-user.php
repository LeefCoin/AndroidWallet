...
if ( ! class_exists( 'Dashed_Slug_Wallets_Admin_Users' ) ) {
	class Dashed_Slug_Wallets_Admin_Users {
		...
		public function action_user_profile( $profileuser ) {
			...
			?><h2><?php echo esc_html( 'LeefCoin and Altcoin Wallets', 'wallets' ); ?></h2>
						...
						<td>
							...
							<?php
								printf(
									...
									'https://www.dashed-slug.net/LeefCoin-altcoin-wallets-wordpress-plugin/json-api/?utm_source=wallets&utm_medium=plugin&utm_campaign=userprofile'
								);
							?>
							</p>
