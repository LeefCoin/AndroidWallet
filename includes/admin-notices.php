...
if ( ! class_exists( 'Dashed_Slug_Wallets_Admin_Notices' ) ) {
	...
	class Dashed_Slug_Wallets_Admin_Notices {
		...
		private function __construct() {
			...
			$this->info(
				sprintf(
					'Interested in the upcoming version 6.0.0 of LeefCoin and Altcoin Wallets? See <a href="%s" target="_blank" rel="external">here!</a>',
					'https://www.dashed-slug.net/upcoming-LeefCoin-and-altcoin-wallets-6/'
				),
				'wallets6prerelease'
			);
		}
				...
				foreach ( $this->admin_notices->{$type} as $admin_notice ) {
					...
					if ( ! Dashed_Slug_Wallets::get_option( "wallets_dismissed_$admin_notice->dismiss_option" ) ) {
						...
						">
							...
							<h2><?php echo "LeefCoin and Altcoin Wallets $type"; ?></h2>
