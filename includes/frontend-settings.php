	...
	class Dashed_Slug_Wallets_Frontend_Settings {
		...
		public function action_admin_menu() {
			if ( current_user_can( 'manage_wallets' ) ) {
				add_submenu_page(
					...
					'LeefCoin and Altcoin Wallets Frontend UI settings',
					'Frontend settings',
					'manage_wallets',
					'wallets-menu-frontend-settings',
		...
		public function action_add_meta_boxes() {
			if ( current_user_can( Dashed_Slug_Wallets_Capabilities::MANAGE_WALLETS ) ) {
				add_meta_box(
					'default-coin',
					__( 'LeefCoin and Altcoin Wallets Default Coin', 'wallets' ),
		...
		public function wallets_frontend_settings_page_cb() {
			...
			?><h1><?php esc_html_e( 'LeefCoin and Altcoin Wallets frontend settings', 'wallets' ); ?></h1>
