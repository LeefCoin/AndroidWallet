...
EMAIL
			...
			if ( isset( $wp->query_vars['__wallets_confirm'] ) ) {
				...
				if ( ! ctype_xdigit( $nonce ) || 32 != strlen( $nonce ) ) {
					wp_die(
						...
						__( 'LeefCoin and Altcoin Wallets transaction confirmation', 'wallets' ),
		...
		public function action_admin_menu() {
			if ( current_user_can( 'manage_wallets' ) ) {
				add_submenu_page(
					...
					'LeefCoin and Altcoin Wallets Transaction confirmations',
					'Confirms',
					'manage_wallets',
		...
		public function wallets_confirmations_page_cb() {
			...
			?><h1><?php esc_html_e( 'LeefCoin and Altcoin Wallets Transaction confirmation settings', 'wallets' ); ?></h1>
				...
				<div class="card">
					...
					<dl>
						...
						<dd><?php esc_html_e( 'The coin symbol for this transaction (e.g. "LFC" for LeefCoin)', 'wallets' ); ?></dd>
